(() => {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    sections.forEach((section) => {
      ...
      section.style.transition = "opacity 0.8s ease, transform 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)";
    ...
    contentLinks.forEach((link) => {
      link.addEventListener("mouseenter", function() {
        const randomColor = brewColors[Math.floor(Math.random() * brewColors.length)];
